#define COMPONENT zeus_comments
#define COMPONENT_BEAUTIFIED Zeus Comments
...
#ifdef DEBUG_ENABLED_ZEUS_COMMENTS
    #define DEBUG_MODE_FULL
#endif

#ifdef DEBUG_SETTINGS_ZEUS_COMMENTS
    #define DEBUG_SETTINGS DEBUG_SETTINGS_ZEUS_COMMENTS
#endif
